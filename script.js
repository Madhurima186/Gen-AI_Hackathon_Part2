...
let userText = null;
const API_KEY = "eyJhbGciOiJSUzI1NiIsIng1dSI6Imltc19uYTEtc3RnMS1rZXktYXQtMS5jZXIiLCJraWQiOiJpbXNfbmExLXN0ZzEta2V5LWF0LTEiLCJpdHQiOiJhdCJ9..WKiASDsRqxAt_RFseTXLpmbdsKkbdZeDHDJXo-ReGj3Lpp2TxvCgBy1eOyN8p2UsS251nTjXps1yAcV8elOZAcTu6QQVKXA0Hb-u1lX2a2hi9zt3NnxHbYcbcHsC08Xatk9btFPvLnE-ebWmpbDampeCVOtCDHt_jgcnWMxzPgBsvAedYvk8oN56CN-aP2YD9u27uaiWNRYdCEoVqIrVKEwwA_HOvOryLqbFITwSzoRc5s5D61kMVPU4GNUlukR4-MSXgyo8OLfJCluI-EaLHNH11ay82gCMq0qtw-wc7K55Tl6ZSznBIrxMBs8xIhmUpNdoQ69vSqVGlzZzpY-OZg"; // Paste your API key here
...
const getConversation = async (incomingChatDiv, userText) => {
    getEmeraldContext(incomingChatDiv, userText);
}


const getEmeraldContext = async (incomingChatDiv, userText) => {
    ...
    try {
        ...
        console.log(response, "::::response getEmeraldContext");
...
const getEmeraldContextData = async (incomingChatDiv, userText, asset_id) => {
